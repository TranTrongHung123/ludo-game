...
public static class CaptureRankingUi
{
    ...
    public static string Main(int width = 1920, int height = 1080, string suffix = "")
    {
        ...
        try
        {
            ...
            string path="Documentation/ranking-"+width+"x"+height+suffix+".png";File.WriteAllBytes(path,texture.EncodeToPNG());return path;
        }
        finally
        {
