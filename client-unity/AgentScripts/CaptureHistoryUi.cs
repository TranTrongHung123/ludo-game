...
public static class CaptureHistoryUi
{
    ...
    public static string Main(int width = 1920, int height = 1080, string suffix = "")
    {
        ...
        try
        {
            ...
            string path="Documentation/history-"+width+"x"+height+suffix+".png";File.WriteAllBytes(path,texture.EncodeToPNG());return path;
        }
        finally
        {
